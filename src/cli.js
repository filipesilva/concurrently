...
var concurrently = require('./main');
var config = concurrently.config;

// Provide a title to the process in `ps`.
process.title = 'concurrently';

// Show deprecation warning if using old name.
...
// Parse options and run concurrently.
var options = parseArgs();
concurrently.run(program.args, options)
